...
const handleGithubLogin = async () => {
  ...
  // Set message or error based on the response
};
  ...
  return (
    <LoginContainer>
      ...
      <LoginButtons>
        ...
        <GitButton type="button" className="github-btn" onClick={handleGithubLogin}>
          <div>
      ...
      <LoginForm onSubmit={handleSubmit}>
        ...
        <LoginButton type="submit">Log in to Qencode</LoginButton>
      </LoginForm>
      <SignUpRow>Is your company new to Qencode? <SignUp to="/signup">Sign up</SignUp></SignUpRow>
    </LoginContainer>
  );
};
